        ...
        <div class="fsec">
            <div class="corplan">
                ...
                <p>Join us for an unforgettable corporate event, where innovation meets collaboration. Network with
                    industry leaders, engage in insightful discussions, and discover cutting-edge solutions to propel
                    your business forward. With exciting speakers, interactive workshops, and ample networking
                    opportunities, this event promises inspiration and growth for all attendees.</p>
            </div>
            <div>
