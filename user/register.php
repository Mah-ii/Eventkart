                ...
                <div class="col-lg-7 text-center py-5">
                    ...
                    <form action="regAction.php" method="post">
                        <div class="form-row py-5">
                            ...
                            <div class="offset-1 col-lg-10 py-2">
                                <label for="regpass"><i><b>Password :</b></i></label>
                                <input type="password" class="input-box" name="regpass" required>
                            </div>
                            <div class="offset-1 col-lg-10 py-2">
                                <label for="regcpass"><i><b>Confrim Password :</b></i></label>
                                <input type="password" class="input-box" name="regcpass" required>
                            </div>
                            <div class="offset-1 col-lg-10 py-2">
                            ...
                            <div class="offset-1 col-lg-10 py-2">
                                <p>Do have an account?
                                    <a href="login.php" style="color: rgb(133, 54, 71);">LogIn</a>
                                </p>
                            </div>
                        </div>
                    </form>
