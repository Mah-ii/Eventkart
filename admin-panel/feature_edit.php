            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="service_type" value="<?php echo $service_type; ?>" class="form-control"
                            id="wedding_type" placeholder="Enter package name">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="<?php echo $title; ?>" class="form-control" id="title"
                            placeholder="Enter the features" style="font-size:15px; margin-bottom:1.2rem;">
                    </div>
                    <div class="form-group">
                        <label for="description">Description:</label>
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control"
                            placeholder="Enter description of the features"><?php echo $description; ?></textarea>
                    </div>
                    <!-- Button container -->
                    <div class="button-container">
                        <button type="submit" name="update" class="btn btn-lg btn-success float-right mr-2"
                            style="font-size: 12px;">Update</button>
                        <a href="services.php" class="btn btn-lg btn-danger float-right"
