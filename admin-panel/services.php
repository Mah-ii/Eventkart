...
<body>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="button-container">
                                    <a href="wedding_package.php" class="btn btn-md btn-success"><i
                                            class="mdi mdi-buffer mr-2"></i>Add New Package.</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="button-container">
                                        <a href="birthday_package.php" class="btn btn-md btn-success"><i
                                                class="mdi mdi-buffer mr-2"></i>Add New Package.</a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-header">
                                        <h4>Features List</h4>
                                        <div class="button-container">
                                            <a href="feature_add.php" class="btn btn-md btn-success"><i
                                                    class="mdi mdi-account-plus"></i>Add New Features.</a>
                                        </div>
                                    </div>
    ...
    <div id="packageDetailsModal" class="modal fade"  role="dialog">
