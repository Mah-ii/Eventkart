                            ...
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <td>
                                                    <a href="blogs_edit.php?id=<?php echo $row['id'] ?>"
                                                    ...
                                                    <a href="eventdetails.php?id=<?php echo $row['id'] ?>" target="_blank"
                                                        class="btn btn-warning btn-sm active"><i
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="button-container">
                                        <a href="client_review.php" class="btn btn-md btn-success"><i
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                while ($row2 = mysqli_fetch_assoc($result2)) {
                                                    ...
                                                    <td>
                                                        <a href="review_edit.php?id=<?php echo $row2['id'] ?>"
                                                            class="btn btn-info btn-sm active"><i
                                                                class="mdi mdi-account-edit"></i></a>

                                                        <a href="review_delete.php?id=<?php echo $row2['id'] ?>"
                                                            class="btn btn-danger btn-sm active"><i class="mdi mdi-delete"
                                                                onclick="return checkdelete()"></i></a>
