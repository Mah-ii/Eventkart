            ...
            <div class="col-lg-8 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="service_type" value="<?php echo $row2['service_type'] ?>"
                            class="form-control" id="wedding_type" placeholder="Enter package name">
                    </div>

                    <div class="form-group">
                        <label for="price">Price Of This Package</label>
                        <input type="text" name="price" value="<?php echo $row2['price'] ?>" class="form-control"
                            id="price" placeholder="Enter the price">
                    </div>
                    ...
                    <a href="service_list.php" class="btn btn-lg btn-danger float-right"
                        style="font-size: 12px;">Cancel</a>

                    <button type="submit" name="update" value="Update Details"
                        class="btn btn-lg btn-success float-right mr-2" style="font-size: 12px;">Update</button>
