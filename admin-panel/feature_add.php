            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control" id="service_type" name="service_type"
                            style="font-size:15px; margin-bottom:1.2rem;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="Enter the features"
                            style="font-size:15px; margin-bottom:1.2rem;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control"
                            placeholder="Enter description of the features"></textarea>
                    </div>
                    <div class="button-container">
                        <button type="submit" name="submit"
                            class="btn btn-primary btn-danger mdi mdi-content-save">Save</button>
                        <a href="services.php" class="btn btn-secondary btn-success float mdi mdi-cancel"
