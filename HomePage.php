...
<head>
    ...
    <!-- <link rel="stylesheet" href="package/wed1.css"> -->
    ...
    <section class="section about" aria-label="about">
        <div class="container">
            <div class="wrapper">
                ...
                <h2 class="h2 section-title">Making easy your event</h2>
            </div>
            ...
            <section class="section blog " aria-labelledby="blog-label">
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        $limit = 2;
                        $sql = "SELECT `id`, `title`, `description`, `image`, `location`, `status`, `event_date`, `event_type`, `date_created` FROM `review` ORDER BY id DESC LIMIT {$limit}";
